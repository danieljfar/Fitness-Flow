    ...
    schemas: {
      ...
      Reservation: {
        ...
        properties: {
          ...
          creditId: { type: 'integer', nullable: true },
          createdBy: { type: 'integer', nullable: true },
          updatedBy: { type: 'integer', nullable: true },
          createdAt: { type: 'string', format: 'date-time' },
          updatedAt: { type: 'string', format: 'date-time' },
  ...
  paths: {
    ...
    '/api/admin/classes': {
      ...
      post: {
        ...
        security: [{ bearerAuth: [] }],
        requestBody: { required: true, content: { 'application/json': { schema: { type: 'object', required: ['name', 'instructorId'], properties: { name: { type: 'string' }, level: { type: 'string' }, durationMinutes: { type: 'integer' }, instructorId: { type: 'integer' }, startsAt: { type: 'string', format: 'date-time' }, capacity: { type: 'integer' } } } } } },
